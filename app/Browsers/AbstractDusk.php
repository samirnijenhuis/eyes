...
abstract class AbstractDusk {
     ...
     * @return void
     */
    public function tearDownDuskClass()
    {
        static::closeAll();
    ...
    /**
     * Alias for TearDownDuskClass
     *
     * @return void
     */
    public function shutdown()
    {
        $this->tearDownDuskClass();
    }
    ...
    protected function captureFailuresFor($browsers)
    {
        $browsers->each(function ($browser, $key) {
            $browser->screenshot('failure-'.$this->getGroup().'-'.$key);
        });
    }
    ...
    {
        $browsers->each(function ($browser, $key) {
            $browser->storeConsoleLog($this->getGroup().'-'.$key);
        });
    }
    ...
    /**
     * Returns the given group (e.g. version-4.2.7)
     *
     * @return string
     */
